                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="sidebar-widget-option-wrapper">
                                @foreach($category_pro as $value)
                                        ...
                                        <ul>
                                            <li class="text-bold"> <a href="{{ route('danh-muc', ['slug'=>$value->slug]) }}">-{{$value->name}} <span>(5)</span></a></li>
                                        </ul>
                                        @foreach($category_pa as $valu)
                                        @if($valu->parent_id==$value->id)
                                        <ul>
                                            <li class="text-bold"> <a href="{{ route('danh-muc', ['slug'=>$valu->slug]) }}">+{{$valu->name}} <span>(5)</span></a></li>
                                        </ul>
                                        @endif
                                        @endforeach
                                        @endif
