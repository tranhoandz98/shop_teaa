                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="sidebar-widget-option-wrapper">
                                ...
                                <div class="sidebar-widget-option">
                                    <a href="{{ route('danh-muc', ['slug'=>$item->slug]) }}">
                                    <input type="checkbox" id="{{$item->name}}{{$item->id}}" name="category" value="{{$item->id}}">
                                ...
                                @foreach($category_pro as $value)
                                    @if($value->parent_id==0)
                                        <ul>
                                            <li class="danh_muc sidebar-widget-option">
                                                <input type="checkbox" id="{{$value->name}}{{$value->id}}">
                                                    <label for="{{$value->name}}{{$value->id}}">
                                                ...
                                                @if($valu->parent_id==$value->id)
                                                    <ul class="danh_muc_con">
                                                        <li> <a href="{{ route('danh-muc', ['slug'=>$valu->slug]) }}">
