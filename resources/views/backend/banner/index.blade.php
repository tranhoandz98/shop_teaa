				...
				<div class="row">
					<div class="col-sm-12">
						<div class="text-sm-left">
							<a href="{{route('banner.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i>Thêm mới banner</a>
						</div>
					</div>
					<div class="col-sm-12">
								...
								<tr>
									...
									<td>
										<div class="row">
											<div class="col">
												<!-- Sửa -->
												<a href="{{route('banner.edit',$value->id)}}" class=" text-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Sửa"><i class="mdi mdi-pencil btn-success btn "></i></a>
											</div>
											<div class="col">
												<!-- Xóa -->
