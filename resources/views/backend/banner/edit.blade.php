...
<div class="row">
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title text-red">Cập nhật banner</h4>
				<div class="container">
					<form action="{{route('banner.update',$banner->id)}}" method="POST" role="form" enctype="multipart/form-data">
                        ...
                        @method('PUT')
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="slug" placeholder="Slug"  name="slug" value={{$banner->slug}}>
								</div>						
										...
										<div class="form-group">
											<div class="row" >
												<div class="card text-center col-md-3">
													<img class="card-img-top img" src="{{url('/public/uploads/')}}/{{$banner->image}}" id="img">
												</div>
											</div>
										</div>
										@error('image')
