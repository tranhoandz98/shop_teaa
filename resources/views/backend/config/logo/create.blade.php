                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label>Logo </label>
                                        <input type="text" class="form-control" id="name" placeholder="Tên logo" name="name"
                                            value="" onkeyup="ChangeToSlug()">
                                        @error('name')
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn-info" data-toggle="modal"
                                            data-target="#modalImage" id="get_image" title="Thêm hình ảnh">
