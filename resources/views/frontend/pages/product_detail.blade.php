                ...
                <div class="row">
                        ...
                        <div class="product-image-slider d-flex flex-column">
                            ...
                            <div class="tab-content product-large-image-list">
                                <div class="tab-pane fade show active" id="product-slide1" role="tabpanel" aria-labelledby="product-slide-tab-1">
                                    <div class="single-product-img easyzoom img-full">
                                        <a href="{{url('public')}}/frontend/img/product/2.jpg"><img src="{{url('public')}}/frontend/img/product/2.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="product-slide3" role="tabpanel" aria-labelledby="product-slide-tab-3">
                                    <div class="single-product-img easyzoom img-full">
                                        <a href="{{url('public')}}/frontend/img/product/4.jpg"><img src="{{url('public')}}/frontend/img/product/4.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="product-slide4" role="tabpanel" aria-labelledby="product-slide-tab-4">
                                    <div class="single-product-img easyzoom img-full">
                                        <a href="{{url('public')}}/frontend/img/product/7.jpg"><img src="{{url('public')}}/frontend/img/product/7.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="product-slide5" role="tabpanel" aria-labelledby="product-slide-tab-5">
                                    <div class="single-product-img easyzoom img-full">
                                        <a href="{{url('public')}}/frontend/img/product/9.jpg"><img src="{{url('public')}}/frontend/img/product/9.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="product-slide6" role="tabpanel" aria-labelledby="product-slide-tab-6">
                                    <div class="single-product-img easyzoom img-full">
                                        <a href="{{url('public')}}/frontend/img/product/17.jpg"><img src="{{url('public')}}/frontend/img/product/17.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!--Product Content End-->
                            ...
                            <div class="product-small-image-list"> 
                                <div class="nav small-image-slider-single-product-tabstyle-3" role="tablist">
                                    ...
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="product-slide-tab-3" href="#product-slide3"><img src="{{url('public')}}/frontend/img/product/4.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="product-slide-tab-4" href="#product-slide4"><img src="{{url('public')}}/frontend/img/product/7.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="product-slide-tab-5" href="#product-slide5"><img src="{{url('public')}}/frontend/img/product/9.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="product-slide-tab-6" href="#product-slide6"><img src="{{url('public')}}/frontend/img/product/17.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="product-details-text">
                            ...
                            <h5><i class="fa fa-check"></i>{{$product->quantity}} in stock</h5>
